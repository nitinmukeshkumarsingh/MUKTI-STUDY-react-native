...
export const getStats = (): UserStats => {
  ...
  // Ensure new fields exist for older stored stats
  ...
  if (stats.cardsMastered === undefined) stats.cardsMastered = 0;
  if (stats.sessionsCompleted === undefined) stats.sessionsCompleted = 0;
  if (stats.totalStudyTime === undefined) stats.totalStudyTime = 0;
